...
# (Optional) Mount Google Drive for session persistence – uncomment if in Colab
...
async def main():
    ...
    # Use SESSION_PATH if you mounted drive
    client = TelegramClient('my_userbot', int(api_id), api_hash, connection_retries=5)
